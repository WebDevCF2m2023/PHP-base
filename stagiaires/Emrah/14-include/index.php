...
<h1>Include</h1>
<?php
// on importe, sans erreurs fatales en cas d'échec, le menu
// le texte "on a du texte ici" malgré l'échec apparait
...
<?php
// on recharge le menu, include permet de recharger autant de X qu'on le souhaite !
include "inc/menu.php";
?>
</body>
</html>
