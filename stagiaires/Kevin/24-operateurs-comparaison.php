...
echo '<p>-- $a = '.$a.' et $b = '.$b.'</p>';
if($a == $b) echo "1) $a est égal == à $b<br>";
else echo "1) $a est différent de $b<br>";
...
if($a === $b) echo "2) $a est strictement égal === à $b<br>";
else echo "2) $a est strictement différent de $b<br>";
...
if($a != $b) echo "2) $a est différent != de $b<br>";
else echo "2) $a est égal à $b<br>";
...
echo '<p>-- $a = '.$a.' et $b = '.$b.'</p>';
if($a < $b) echo "5) $a est inférieur < à $b<br>";
...
if($a > $b) echo "6) $a est supérieur > à $b<br>";
else "6) $a est inférieur ou égal à $b<br>";
...
if($a <= $b) echo "7) $a est inférieur ou égal <= à $b<br>";
else "7) $a est supérieur à $b<br>";
...
if($a >= $b) echo "8) $a est supérieur ou égal >= à $b<br>";
