...
<body>
    ...
    <section>
        ...
        <p>Cette séparation sera la première étape (et la seule demandée pour le <span class="txtBold">TI1 de Pierre et moi</span>) vers un modèle <span class="txtBold">MVC</span> (Model-View-Controller | <a href="https://developer.mozilla.org/fr/docs/Glossary/MVC" target="_blank">Lien</a>) :<br><br>
