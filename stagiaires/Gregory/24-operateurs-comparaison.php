...
echo '<p>-- $a = '.$a.' et $b = '.$b.'</p>';
echo $a==$b ? "1) $a est égal == à $b<br>" : "1) $a est différent de $b<br>";
...
echo $a===$b ? "2) $a est strictement égal === à $b<br>" : "2) $a est strictement différent de $b<br>";
...
echo $a!=$b ? "2) $a est différent != de $b<br>" : "2) $a est égal à $b<br>";
...
echo $a!==$b ? "4) $a est strictement différent !== de $b<br>" : "4) $a est strictement égal à $b<br>";
...
echo '<p>-- $a = '.$a.' et $b = '.$b.'</p>';
echo $a<$b ? "5) $a est inférieur < à $b<br>" : "5) $a est supérieur ou égal à $b<br>";
...
echo $a>$b ? "6) $a est supérieur > à $b<br>" : "6) $a est inférieur ou égal à $b<br>";
...
echo $a<=$b ? "7) $a est inférieur ou égal <= à $b<br>" : "7) $a est supérieur à $b<br>";
...
echo $a>=$b ? "8) $a est supérieur ou égal >= à $b<br>" : "8) $a est inférieur à $b<br>";