...
if ($age >= 18 && $genre === "F") echo "1) Bienvenue sur le site<br>"; else echo "1) Désolé, accès réservé aux femmes majeures uniquement<br>";
...
// Sinon on affiche "3) La note $note vaut 10<br>"
if ($note < 10 xor $note > 10) echo "3) La $note est soit inférieure à 10, soit supérieure à 10<br>"; else echo "3) La note $note vaut 10<br>";
...
if (!($pageActu == $nbPage)) echo "4) Nous ne sommes pas sur la dernière page $pageActu / $nbPage<br>"; else echo "4) Nous sommes sur la dernière page $pageActu / $nbPage<br>";