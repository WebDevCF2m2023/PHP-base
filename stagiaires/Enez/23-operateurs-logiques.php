...
if ($page < 10 or $page > 20) {
    echo "2) La page est soit inférieure à 10, soit supérieure à 20<br>";
} else {
    echo "2) La page est entre 10 et 20<br>";
}
