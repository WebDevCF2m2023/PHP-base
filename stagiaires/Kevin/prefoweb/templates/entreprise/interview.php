<?php require("../templates/inc/head.php"); ?>
  ...
  <body>
    ...
    <main>
      <div id="content">
        <article id="infos">
          <section id="card">
            <div id="profile">
              <img src="images/interview/victor_petit.jpg" alt="" />
            </div>
            <div id="description">
              <span>Victor Petit</span>
            ...
            <div id="social-media">
              ...
              <div>
                <a
                  href="https://www.linkedin.com/in/victor-petit-a372a213b/"
                  target="_blank"
                >
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                j’avais 12 ou 13 ans. <br />J’essayais de faire mes petits sites
                en html/css et par la suite avec php. <br />Je n’ai pas eu de
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                cette façon de recruter. <br />Par la suite on m’a souvent dit
                que l’entreprise a continué à recruter de cette façon-là, donc
                ça m’a plu. <br />Surtout dans le domaine du numérique je suis
                persuadé qu’il y a beaucoup de personnes comme moi qui ont fait
                en autodidacte. <br />Donc c’est quand même bien qu’il y ait des
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                avant et donc ils ne m’ont pas choisi à l’aveugle. <br />Ils
                ...
                mois ils auraient le temps de me former. <br />Pendant ce
                ...
                retours. <br />A l’époque je travaillais sur un site sur
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                “immotep” mais je ne suis pas sûr. <br />Mais alors non il n’y
                ...
                technos un peu plus récents quand même. <br />Mais là c’était
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                niveau rapidement. <br />Ensuite j’ai switché vers le Pôle
                “dotnet” où ça faisait du C# et des technos front end, React
                etc... <br />C’était la première fois à l’époque qu’ils
                introduisaient un projet en React alors que maintenant c’est
                devenu complètement la norme. <br />Mais à l’époque ils étaient
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                tant que simple intégrateur de la solution. <br />Ça arrive
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                forcément plus que d'autres. <br />J’ai ensuite appris la
                technologie mobile avec principalement la technologie flutter.
                <br />Alors forcément je me suis retrouvé avec des contextes
                ...
                demandes. <br />Actuellement je suis sur deux missions
                ...
                je dois réaliser la résolution en Flutter. <br />Ça fait
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                sur Paris. <br />Alors tout ce qui était vendu, les commerciaux
                etc... On ne connaissait pas nous. Les commerciaux tout était
                vendu sur Paris au niveau du siège. <br />Et ensuite ils
                ...
                je pouvais voir c’était le chef de l’agence. <br />Mais sinon on
                ...
                <br />L'organigramme n'est pas la même pour toute les
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                <br />Le front end était en React et moi j’étais sur ce projet
                là pour faire une web application pour gérer les raffineries de
                Total. <br />On devait donc pouvoir suivre, faire les
                statistiques sur les flux, suivre les membres etc...
                <br />Tandis qu'en PHP j’ai fait de tout, que ce soit back ou
                front. <br />Mais malgré le fait que j’étais dans le Pôle
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                communication avec le client. <br />Je voulais avoir le retour
                des clients des produits que je faisais pour avoir leur avis.
                <br />Car quand tu es junior, selon le poste que tu es c’est
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                <br />Il y a aussi le côté où le lead dev côté front est parti.
                ...
                formation. <br />Donc c’était un sacré chantier à devoir
                ...
                problème de compétence. <br />Surtout qu’il n’y a pas eu une
                ...
                forcément ça nuit dans la cohésion d’équipe. <br />Mais malgré
                ...
                aussi. <br />Mais on a réussi à le mettre en “prod”. On m’a dit
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                minimum à Amiens ou d’autres région. <br />La fourchette change
          ...
          <section class="showingDiv">
            ...
            <div>
              <p>
                ...
                des choses actuellement. <br />Si je vais dans un pays où je ne
                ...
                l’édifice ? <br />Je ne sais pas en tout cas j’aurais moins
                cette « niaque-là ».
              </p>
            </div>
          </section>
        ...
        <article id="conclusion">
          ...
          <h2>Confirmation Orientation :</h2>
          <p>
    ...
    <script src="scripts/entreprise/slideCard.js"></script>
    <script src="scripts/index/clouds.js"></script>
    <script>
      activateClouds(35, "images/clouds/cloud");
    </script>
  </body>
</html>
