...
if ($a == $b) {
    echo "1) $a est egal == a $b<br>";
} else {
    echo "1) $a est different  $b<br>";
}
...
if ($a === $b){
    echo "2) $a est strictement egal === $b<br>";
}else {
    echo "2) $a est strictement different !== $b<br>";
}


if ($a != $b){
 
    echo "3) $a est strictement différent !== de $b<br>";
}
else {
    echo "3) $a est strictement égal à $b<br>";
}
/*
 * 3) != : différent de
 */
...
if ($a < $b){
    ...
    echo "5) $a est strictement inferieur < de $b<br>";
}
else {
    echo "5) $a est strictement superieur  $b<br>";
}
 ...
 */if ($a > $b){
    ...
    echo "6) $a est strictement superieur > de $b<br>";
}
else {
    echo "6) $a est strictement inferieur à $b<br>";
}
