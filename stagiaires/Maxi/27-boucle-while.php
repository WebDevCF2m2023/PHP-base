...
while (true) {
    ...
    if ($randomNumber == $targetCondition) {
        echo "Target condition met! Random number: $randomNumber";
        break; 
    }
    ...
    if ($iterations >= 100) {
        echo "Maximum iterations reached without meeting the target condition.";
        break;
    }
}
