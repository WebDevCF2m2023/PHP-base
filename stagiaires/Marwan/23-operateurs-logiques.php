...
if($age >= 18 && $genre == 'F' ){
    ...
    echo "Désolé, accès réservé aux femmes majeures uniquement<br>";
}
...
if($page < 10 || $page > 20){
    echo"La page $page est soit inférieure à 10, soit supérieure à 20<br>";
}
else{
    echo"La page $page est entre 10 et 20<br>";
}
...
if($note<10 ^ $note > 10){
    echo"La $note est soit inférieure à 10, soit supérieure à 10<br>";
}
else{
    echo "La $note est 10<br>";
}
...
if(!($pageActu==$nbPage)){
    echo"Nous ne sommes pas sur la dernière page $pageActu / $nbPage<br>";
}
else{
    echo "Nous sommes sur la dernière page $pageActu / $nbPage<br>";
}
